...
public class AlbumDetailAdapter extends RecyclerView.Adapter<AlbumDetailAdapter.ViewHolder> {
     ...
     *
     */
    public AlbumDetailAdapter(List<MediaMetadataCompat> songlist, FragmentActivity activity) {
    ...
    @Override
    public AlbumDetailAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                String queueTitle = "album" + songlist.get(selected_position).getLong("albumId");
                ...
                if (mController.getMetadata().getString(MediaMetadataCompat.METADATA_KEY_MEDIA_ID).equals(songlist.get(selected_position).getString(MediaMetadataCompat.METADATA_KEY_MEDIA_ID))) {
                    ...
                    bundle.putLong("albumId", songlist.get(selected_position).getLong("albumId"));
