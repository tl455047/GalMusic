...
public class AlbumDetailLoader {
    public static final List<MediaMetadataCompat> getSongList(Context context, String albumId) {
        ...
        try (Cursor cursor = context.getContentResolver().query(
            ...
            while (cursor.moveToNext()) {
                ...
                Uri uriSongCover = ContentUris.withAppendedId(songCover, Long.parseLong(albumId));
